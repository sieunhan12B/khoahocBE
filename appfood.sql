...
select u.user_id, u.full_name,COUNT(lr.user_id) AS like_count from users as u 
...
select r.res_id, r.res_name, count(lr.res_id) as like_count from restaurant as r 
